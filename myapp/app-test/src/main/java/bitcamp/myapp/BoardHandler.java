...
public class BoardHandler {
  ...
  // 모든 인스턴스가 공유하는 데이터는 스태틱 필드로 만든다.
  // 특히 데이터를 조회하는 용으로 사용하는 final 변수는 스태틱 필드로 만들어야한다.
  ...
  // 인스턴스를 만들 때 프롬프트 제목을 반드시 입력하도록 간제한다.
  BoardHandler(String t) {
    this.t = t;
  }
  ...
  void menu() {
    while (true) {
      ...
      int menuNo = Prompt.inputInt(String.format("%s> ", this.t));
