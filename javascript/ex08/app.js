...
app.get('/hello', (req, res) => { // hello 부분은 요청 핸들러라고 함
  res.set('Access-Control-Allow-Origin', '*'); // 응답 헤더
  res.set('Content-Type', 'text/plain; charset=UTF-8'); // 응답 헤더

  setTimeout(() => { // () => {} 부분이 setTimeout의 핸들러
    res.send("Hello!");
  }, 3000);
}); 
